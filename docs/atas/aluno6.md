...
| 23/02 - 01/03 | Arquitetura de Software Distribuído - Unidade 1 e 2 | ⬜ | Restrições e Catálogo de Serviços | Definição das restrições do projeto e revisão do Catálogo de Serviços. |
